<h2><a href="https://www.geeksforgeeks.org/problems/bleak-numbers1552/1?page=1&category=Bit%20Magic&difficulty=Medium&sortBy=submissions">Bleak Numbers</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an integer, check whether it is <strong>Bleak or not</strong>. </span></p>
