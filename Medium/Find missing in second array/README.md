<h2><a href="https://www.geeksforgeeks.org/problems/in-first-but-second5423/1?page=3&category=Mathematical,Sorting,Hash,Map,set&difficulty=Medium&sortBy=submissions">Find missing in second array</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two arrays <strong>A</strong> and <strong>B </strong>contains&nbsp;integers of size <strong>N</strong> and <strong>M</strong>, the task is to find numbers which are present in the&nbsp;first array, but not present in the second array.</span></p>
